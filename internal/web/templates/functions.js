...
function setupRoutePrefetch() {
    ...
    const warmRoutes = (() => {
        ...
        if (path.startsWith('/app/perfil') || path.startsWith('/app/settings')) {
            return ['/app/reportes', '/app/apple-wallet', '/app/telegram', '/app/table', '/app/categorias', '/app/recurrentes', '/app'];
        }
        if (path.startsWith('/app/categorias') || path.startsWith('/app/recurrentes') || path.startsWith('/app/conciliacion') || path.startsWith('/app/reportes') || path.startsWith('/app/apple-wallet') || path.startsWith('/app/telegram')) {
